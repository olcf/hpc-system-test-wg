...
## Details
* **When**: 25, April 2026, held in conjunction with CUG 2026
* **Where**: Observatoire de la côte d'Azur, Site du Mont-Gros, Boulevard de l’Observatoire, 06304, Nice
...
* Energy Measurement and Energy-Related Testing
* AI / ML Benchmarking and Validation
...
|Time|Speaker|Title|Short description|
|---|---|---|---|
| 11:30 – 11:45 | Jenett Tillotson (UCAR) | Keeping a 20PF Slingshot Machine Performant | We will present an Application Workload Test (AWT) and a low-level MPI Slingshot test (pray4us) we use to attempt to track down Slingshot issues before returning from outages |
...
| 12:15 – 12:30 | Ryan Adamson (ORNL) | Adapting Kernel Security Testing to HPC Systems | We will introduce Syzkaller, an industry standard tool for discovering bugs in the Linux kernel, and the lessons learned in adapting the tool to test the COS kernel on Frontier-like hardware. |
...
Participants will be divided into working groups focusing on key aspects of HPC system testing. Each group will explicitly **build on the existing test lists** (provided in the [working-groups](https://git.cines.fr/external/Testathon-cug-2026/-/tree/main/working-groups?ref_type=heads) folder files), refining them based on current needs. 
